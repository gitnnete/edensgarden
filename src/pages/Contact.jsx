  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center mb-18">
        <h2 className="pr-4 text-2xl md:text-5xl text-gray-800 font-semibold">Contact Us</h2>
      ...
      <div className="flex flex-col md:flex-row items-start gap-8">
        ...
        <div data-aos="fade-right" className="md:w-1/2 flex flex-col">
          <p className="text-lg text-gray-700 mb-4">
            Reach out to us for all your landscaping needs. We’re here to help you create the perfect outdoor space.
          </p>

          {/* Contact Info */}
          <div className="mb-8 mt-2">
            <p className="text-lg font-semibold">
              Email: <span className="text-green-600">info@edensgarden.com</span>
            </p>
            <p className="text-lg font-semibold">
        ...
        <div data-aos="zoom-in" className="md:w-1/2 flex justify-center">
          <img
            src={contactImg}
            alt="Contact Us"
            className="w-full h-full md:h-auto max-h-[500px] object-cover rounded-lg shadow-lg"
          />
        </div>
      </div>
    </div>
